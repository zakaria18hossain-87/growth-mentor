...
Growth Mentor: a 10-year-vision-anchored weekly scorecard app for tracking goals across health, soft skills, development, and education — replacing a personal growth coach with a data-driven self-assessment system.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "324125111+zakaria18hossain-87@users.noreply.github.com"
  git config user.name "zakaria18hossain-87"
  ```
