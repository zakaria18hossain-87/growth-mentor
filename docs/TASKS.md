...
- [x] Create Supabase tables (visions, goals, scorecards, scorecard_entries) + seed data
- [x] Build `lib/data/` access layer for all four tables
- [x] Scorecard page: fetch active goals, render scoring form (0–10 per goal + note)
- [x] Submit scorecard → persist entries to DB
- [x] Scorecard history page: list past scorecards with scores
- [x] Scoring utils: pillar averages, weekly overall score
...
- [x] Vision page: create/edit 10-year vision statement
- [x] Goals page: create long/short-term goals with pillar tag + target date
- [x] Edit/archive/complete goals
- [x] Goals feed into scorecard generation automatically
...
- [x] Dashboard: current week pillar averages + overall score
- [x] Trend chart: pillar scores over weeks
- [x] Vision-alignment indicator
- [x] Responsive sidebar nav (Dashboard, Vision, Goals, Scorecards)
